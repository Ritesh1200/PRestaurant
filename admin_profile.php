...
<div class = "container-fluid row class">
  <div class = "col-lg-5 col-md-5 col-12  ">
    <table class = " table table-hover">
      ...
      <tbody>
        <tr><td> <a class = " bg-white text-dark border-0" href = "admin_show_order.php"> <h3  style= "font-family :Bradley Hand, cursive ;">Order history <h3> </a> </td> </tr>
  ...
  <?php
        $query = "select AP_text from AAcc where AEmail = '$email'" ;
    ...
    <?php
      if(isset($_POST['text'])){
        $text = $_POST['text'] ;
        $qry = "UPDATE AAcc SET AP_text = '$text' WHERE  AEmail = '$email'" ;
        $conn->query($qry) ;
